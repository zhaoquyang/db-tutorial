...
![img](https://gitee.com/quyangzhao/images/raw/dev/snap/20200716103611.png)
...
![img](https://gitee.com/quyangzhao/images/raw/dev/snap/20200716074533.png)

### [Mysql 锁](04.Mysql锁.md)

> 关键词：`乐观锁`、`表级锁`、`行级锁`、`意向锁`、`MVCC`、`Next-key 锁`

![img](https://gitee.com/quyangzhao/images/raw/dev/snap/20200716064947.png)

### [Mysql 索引](05.Mysql索引.md)

> 关键词：`Hash`、`B 树`、`聚簇索引`、`回表`

![img](https://gitee.com/quyangzhao/images/raw/dev/snap/20200715172009.png)
