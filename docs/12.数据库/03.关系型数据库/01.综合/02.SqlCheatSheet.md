...
![img](https://gitee.com/quyangzhao/images/raw/master/cs/database/mysql/sql-syntax.png)
...
- 内部查询首先在其父查询之前执行，以便可以将内部查询的结果传递给外部查询。执行过程可以参考下图：
  ...
  <p align="center">
    <img src="https://gitee.com/quyangzhao/images/raw/dev/cs/database/mysql/sql-subqueries.gif" alt="sql-subqueries">
  </p>
...
<div align="center">
  <img src="https://gitee.com/quyangzhao/images/raw/dev/cs/database/mysql/sql-join.png" alt="sql-join">
</div>
